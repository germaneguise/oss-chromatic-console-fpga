...
add_file -type verilog "src/rtl/BSP/system_monitor.sv"
...
add_file -type verilog "src/rtl/BSP/vid_system_top.sv"
...
# Present in evt1_x2.gprj but absent here, so command-line builds were
# missing them entirely.
add_file -type verilog "src/rtl/BSP/button_debounce.v"
add_file -type vhdl "src/rtl/BSP/overlayBatteryBack.vhd"
add_file -type vhdl "src/rtl/BSP/overlayBatteryFront.vhd"
add_file -type vhdl "src/rtl/BSP/overlayDebug.vhd"
add_file -type vhdl "src/rtl/BSP/overlayTimerBack.vhd"
add_file -type vhdl "src/rtl/BSP/overlayTimerFront.vhd"
add_file -type vhdl "src/rtl/BSP/overlayTimerNumber.vhd"
add_file -type verilog "src/rtl/BSP/system_monitor_arbiter.sv"
add_file -type verilog "src/rtl/BSP/uart_packet_wrapper_rx.sv"
add_file -type verilog "src/rtl/BSP/uart_packet_wrapper_tx.sv"
add_file -type verilog "src/rtl/EMU/CORE/videoBypass.v"
add_file -type verilog "src/rtl/EMU/audio_filter.v"
add_file -type verilog "src/rtl/EMU/iir_filter.sv"
